...
<body>
    ...
    <div id="slideshow">
        <div id="slides">
            <div class="slide">
            <h1 id="section-heading">Why do we need CSS?</h1>
    <div id="main-container">
        <div id="slide1">
            <p class="para">
                CSS, or Cascading Style Sheets, is a fundamental technology used in web development. 
                It lets developers choose colors, fonts,<img src="../../Attributes/Images/cssLogo.png" id="cssLogo"> spacing, and all sorts
                of cool stuff to make websites look just right.CSS also helps with making websites work well on different devices.
                By customizing fonts, colors, and layout properties, CSS makes sure that everyone can access and enjoy the content.
            </p>
            <figure>
                <img id="bocLogo" src="../../Attributes/Images/bocLogo.jpg" width="450px" height="278px">
