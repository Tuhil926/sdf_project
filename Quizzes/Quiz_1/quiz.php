...
<?php
    ...
    <div class="quiz">
        <div class="left_panel">
            <div class="question">
                <h1>AC Class</h1>
                We have a class named "test" (quotes for clarity). You have to change its font size to 64 pixels and color to #FF2171.
                <br>Hint: Use CSS
            </div>
        ...
        <div class="result">
            ...
            <div class="output" id="output">
                <div class="test" id="a">Class selectors have a .(dot) before class name.</div>
            </div>
            <div id="expected">
                <div>Class selectors have a .(dot) before class name.</div>
            </div>
        </div>
        
    </div>

    <a id="next" href="../Quiz_2/quiz.php">Next</a>
</body>
