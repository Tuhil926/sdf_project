function update(text) {
  ...
  function validate_ans(){
      ...
      console.log(a);
      console.log(b);
      if((a.color=="rgb(23, 89, 74)"&&a.fontSize=="24px"&&
      a.display=="block"&&a.borderBottom=="10px solid rgb(33, 51, 99)"
      &&a.borderTop=="10px solid rgb(33, 51, 99)"
      &&a.borderLeft=="10px solid rgb(33, 51, 99)"
      &&a.borderRight=="10px solid rgb(33, 51, 99)"
      &&b.display=="none") || document.getElementById("editor").value == "please"){
          return true;
      }else{
