function update(text) {
  ...
  function validate_ans(){
      ...
      if (a.fontSize=="30px"&&a.textAlign=="center"&&a.margin=="20px"&&a.padding=="20px"&&a.backgroundColor=="rgb(203, 186, 142)"&&a.opacity=="0.5"&&b.height=="200px"&&b.backgroundColor=="rgb(141, 128, 96)"&&b.borderRadius=="40px"){
          return true;
      }else{
