function update(text) {
  ...
  function validate_ans(){
      ...
      console.log(a);
      if (a.display=="flex"&&a.height=="400px"&&a.backgroundColor=="rgb(49, 29, 63)"&&a.color=="rgb(226, 62, 87)"&&a.fontSize=="16px"&&a.flexDirection=="column"&&a.justifyContent=="flex-end"){
          return true;
      }else{
